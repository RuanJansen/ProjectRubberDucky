...
private class AuthenticationDependency5a6de97900558ad86deeProvider: AuthenticationDependency {
...
/// ^->RootComponent->AuthenticationsComponent
private func factorya111e2a1e263790766a2b3a8f24c1d289f2c0f2e(_ component: NeedleFoundation.Scope) -> AnyObject {
    return AuthenticationDependency5a6de97900558ad86deeProvider(rootComponent: parent1(component) as! RootComponent)
}
...
extension RootComponent: Registration {
    public func registerItems() {
        ...
        localTable["authenticationComponent-AuthenticationsComponent"] = { [unowned self] in self.authenticationComponent as Any }
        ...
        localTable["token-String"] = { [unowned self] in self.token as Any }
    }
}
...
extension AuthenticationsComponent: Registration {
    public func registerItems() {
...
@inline(never) private func register1() {
    ...
    registerProviderFactory("^->RootComponent->AuthenticationsComponent", factorya111e2a1e263790766a2b3a8f24c1d289f2c0f2e)
